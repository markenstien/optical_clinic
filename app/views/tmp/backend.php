...
<head>
    ...
    <link href="<?php echo _path_tmp('sbadmin/vendor/fontawesome-free/css/all.min.css')?>" rel="stylesheet" type="text/css">
    <link
        href="https://fonts.googleapis.com/css?family=Nunito:200,200i,300,300i,400,400i,600,600i,700,700i,800,800i,900,900i"
        rel="stylesheet">

    <!-- Custom styles for this template-->
    <link href="<?php echo _path_tmp('sbadmin/css/sb-admin-2.min.css')?>" rel="stylesheet">
...
<body id="page-top">
    ...
    <script src="<?php echo _path_tmp('sbadmin/vendor/jquery-easing/jquery.easing.min.js')?>"></script>
